package com.longluo.java.interview.MultiThreads.threads.rwlock;
...
class User implements Runnable {
	...
	private ReentrantReadWriteLock myLock; // 执行操作所需的锁对象
	private boolean ischeck; // 是否查询

	User(String name, MyCount myCount, int iocash, ReentrantReadWriteLock myLock,
			boolean ischeck) {
		this.name = name;
