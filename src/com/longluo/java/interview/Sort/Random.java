package com.longluo.java.interview.Sort;
...
class Random31 {
	...
	/**
	 * Construct this Random object with initial state obtained from system
	 * clock.
	 */
	public Random31() {
	...
	/**
	 * Return a pseudorandom int in range [0..high), and change the internal
	 * state.
	 * 
	 * @return the pseudorandom int.
	 */
	...
	/**
	 * Return a pseudorandom double in the open range 0..1 and change the
	 * internal state.
	 * 
	...
	/**
	 * Return an int in the closed range [low,high], and change the internal
	 * state.
	 * 
	 * @param low
	...
	/**
	 * Return a long somewhat in the range [1, 2^62-1), and change the internal
	 * state. Note that all longs can be generated.
	 * 
	...
	/**
	 * Return an int using a Poisson distribution, and change the internal
	 * state.
	 * 
	 * @param expectedValue
	...
	/**
	 * Return a double using a negative exponential distribution, and change the
	 * internal state.
	 * 
	 * @param expectedValue
	 *            the mean of the distribution.
	 ...
	 */
	private static final <AnyType> void swapReferences(AnyType[] a, int index1,
			int index2) {
	...
	/**
	 * Randomly rearrange an array. The random numbers used depend on the time
	 * and day.
	 * 
	 * @param a
	 *            the array.
...
/**
 * Random48 number class, using a 48-bit linear congruential generator.
 * 
 * @author Mark Allen Weiss
 */
class Random48 {
	...
	/**
	 * Return a pseudorandom double in the range [0..1) and change the internal
	 * state.
	 * 
	 * @return the pseudorandom double.
	 */
	...
	/**
	 * Return a 64-bit long, and change the internal state. Note that all longs
	 * can be generated.
	 * 
	 * @return the pseudorandom long.
	 */
